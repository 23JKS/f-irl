...
from common.sac_oer import ROERReplayBuffer, ReplayBuffer, SAC 
import datetime
import dateutil.tz
import json, copy
...
if __name__ == "__main__":
    ...
    # logs
    exp_id = f"logs/{env_name}/exp-{num_expert_trajs}/{v['obj']}-oer/{seed}" # task/obj/date structure
    # exp_id = 'debug'
    ...
    os.system(f'cp firl_roer/2.py {log_folder}')
    ...
    # Always use ROERReplayBuffer, but priority updates are disabled for the first 80%
